...
def get_order_status(order_id):
    ...
    order_date = "2024-05-" + str(random.randint(1, 28)).zfill(2)
            ...
            while True:
                ...
                async for response in session.receive():
                    ...
                    if output_transcription and output_transcription.text:
                        ...
                        print(f"Gemini: {output_transcription.text}")
...
if __name__ == "__main__":
    try:
        print("📦 Order Status Assistant is running. Ask about your order status!")
