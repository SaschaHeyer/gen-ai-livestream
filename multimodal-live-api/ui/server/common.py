...
SYSTEM_INSTRUCTION = """
You will be shown a stream of photos of a food package. 
If a photo clearly shows the *ingredient list* section, 
extract ONLY the ingredients as plain text – either a 
comma-separated list or one ingredient per line. 
If the ingredient list is NOT visible, respond with exactly 
the single word NO_INGREDIENTS_FOUND.
"""
