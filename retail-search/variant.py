# Import products into a catalog with proper primary and variant relationships using Retail API
import random
import string
import time
...
# Prepare products to import (example remains the same)
def prepare_products():
    ...
    primary_product = Product(
        ...
        images=[
            ...
            Image(uri="https://storage.googleapis.com/doit-retail-search/black_thumbnail.png"),
        ],
    ...
    variant1 = Product(
        ...
        images=[
            ...
            Image(uri="https://storage.googleapis.com/doit-retail-search/beige_thumbnail.png"),
        ],
        type_=Product.Type.VARIANT,
        primary_product_id="primary_case_black",
    )
    products.append(variant1)

    variant2 = Product(
        id="variant_case_yellow",
        ...
        images=[
            ...
            Image(uri="https://storage.googleapis.com/doit-retail-search/yellow_thumbnail.png"),
        ],
        type_=Product.Type.VARIANT,
        primary_product_id="primary_case_black",
    )
