...
On wine, all three models tie at accuracy 1.0000. TabFM pays 55 seconds and a 6.6 GB checkpoint for it, TabICL 2.5 seconds and 0.11 GB, XGBoost 0.4 seconds. On a Vertex AI L4 GPU TabFM drops to 3.6 seconds, still 9x slower than XGBoost on a plain CPU. The takeaway is not that TabFM is bad, it is that a leaderboard number is not your data. Benchmark on your own table before you swap anything out.
